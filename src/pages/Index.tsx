...
const Index = () => {
  ...
  return <div className="min-h-screen bg-black flex flex-col pb-20">
      <Navbar />
      ...
      <section className="relative h-[600px] md:h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container text-center text-white relative z-10">
          ...
          <Button size="lg" className="animate-fade-in-up-delay bg-primary hover:bg-primary/90 text-white px-8 py-6 text-lg" onClick={() => navigate('/catalog')}>
            Shop Now
          </Button>
        </div>
      </section>
      ...
      <section className="container py-16 md:py-24">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {categories.map(category => <Link key={category.name} to={category.link}>
...
 Shop Deals</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          tag: "2 FOR 1"
        }].map((deal, index) => <Card key={index} className="group overflow-hidden cursor-pointer hover:shadow-xl transition-all" onClick={() => navigate('/catalog')}>
        ...
        <div className="text-center mt-12">
          <Button size="lg" className="bg-accent hover:bg-accent/90 text-white px-8 py-6 text-lg" onClick={() => navigate('/catalog')}>
